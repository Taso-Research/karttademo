...
map.getView().fit([2059661.355593, 8155455.064292, 3823919.843880, 9285232.561695], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Elinvoima-analyysi</h2>';
        return titleElement;
    })(),
